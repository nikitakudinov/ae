                                                          ...
                                                          child: Container(
                                                            ...
                                                            child:
                                                              ...
                                                              child:
                                                                  ExpandablePanel(
                                                                header: Text(
                                                                  'Еще на (${FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == codesItem) && (e.stock == 1)).toList().sortedList((e) => e.deliveryTime).length.toString()}) складах',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .labelMedium,
                                                                ),
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Все предложения (${FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == codesItem) && (e.stock != 1)).toList().sortedList((e) => e.deliveryTime).length.toString()})',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .titleSmall,
                                                        ),
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  return Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if (codeItemsIndex !=
                                                                          (FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == codesItem) && (e.stock != 1)).toList().length -
                                                                              1))
                                                                        Container(
                                                                          width:
