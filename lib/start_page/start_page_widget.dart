                                      ...
                                      if ((_model.apiResultnpb?.succeeded ??
                                        ...
                                        setState(() {
                                          ...
                                          FFAppState().SEARCHHISTORYvisibility =
                                              false;
                                          FFAppState()
                                              .SEARCHBRANDCODEvisibility = true;
                                        });
                                      }
                                                                      ...
                                                                      children: [
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final cODEitemTITLE =
                                                                                FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem)).toList().take(1).toList();
                                                                            return ListView.builder(
                                                                              padding: EdgeInsets.zero,
                                                                              primary: false,
                                                                              shrinkWrap: true,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            if (FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem) && (e.stock == 1)).toList().sortedList((e) => e.deliveryTime).length !=
                                                                                0)
                                                                              Container(
                                                                                decoration: BoxDecoration(),
                                                                                child: Container(
