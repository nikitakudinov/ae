                                    ...
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      () async {
                                        ...
                                        if ((_model.apiResultnpb?.succeeded ??
                                            true)) {
                                          _model.data = await actions
                                              .jsonBrandCodeSearchResult(
                                            getJsonField(
                                                                    ...
                                                                    () {
                                                                      if (dateTimeFormat(
                                                                        ...
                                                                        return dateTimeFormat(
                                                                          'relative',
                                                                          functions
                                                                              .newCustomFunction3(stockitemsItem.deliveryTime),
                                                                          locale:
                                              ...
                                              child: ExpandablePanel(
                                                ...
                                                expanded: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final allstockitems = FFAppState()
                                                            .sr
                                                            .where((e) =>
                                                                (e.cross ==
                                                                        null ||
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              dateTimeFormat(
                                                                                'Hm',
                                                                                functions.newCustomFunction3(allstockitemsItem.deliveryTimeMax),
                                                                                locale: FFLocalizations.of(context).languageShortCode ?? FFLocalizations.of(context).languageCode,
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).labelSmall,
                                                                            ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Builder(
                                                                            builder:
                                                                                (context) {
                                                                              final cODEitemTITLE = FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem)).toList().take(1).toList();
                                                                              return ListView.builder(
                                                                                padding: EdgeInsets.zero,
                                                                                primary: false,
                                                                                shrinkWrap: true,
                                                                                scrollDirection: Axis.vertical,
                                                                                itemCount: cODEitemTITLE.length,
                                                                                itemBuilder: (context, cODEitemTITLEIndex) {
                                                                                  final cODEitemTITLEItem = cODEitemTITLE[cODEitemTITLEIndex];
                                                                                  return Visibility(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          final codeItems = FFAppState()
                                                                              .sr
                                                                              .where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem))
                                                                              .toList()
                                                                              .sortedList((e) => e.price)
                                                                              .toList()
                                                                              .take(1)
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          builder:
                                                                              (context) {
                                                                            final codeItems =
                                                                                FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem)).toList().sortedList((e) => e.deliveryTime).toList().take(1).toList();
                                                                            return ListView.builder(
                                                                              padding: EdgeInsets.zero,
                                                                              primary: false,
                                                                              shrinkWrap: true,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Builder(
                                                                                builder: (context) {
                                                                                  final stockItems = FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem) && (e.stock == 1)).toList().sortedList((e) => e.deliveryTime).toList().take(3).toList();
                                                                                  return ListView.builder(
                                                                                    padding: EdgeInsets.zero,
                                                                                    primary: false,
                                                                                    shrinkWrap: true,
                                                                                    ...
                                                                                    itemBuilder: (context, stockItemsIndex) {
                                                                              ...
                                                                              if (FFAppState().sr.where((e) => ('\"${e.code}\"' == codesItem) && ('\"${e.brand}\"' == brandsItem) && (e.stock == 1)).toList().sortedList((e) => e.deliveryTime).length != 0)
                                                                                Container(
                                                                                  decoration: BoxDecoration(),
                                                                                  child: Container(
                                                                                    width: double.infinity,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              theme: ExpandableThemeData(
                                                                                ...
                                                                                iconSize: 15.0,
                                                                                iconPadding: EdgeInsets.fromLTRB(0.0, 0.0, 23.0, 0.0),
                                                                              ),
                                                                            ),
                                                                          ),
                                                                        ),
